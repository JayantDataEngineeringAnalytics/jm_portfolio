...
# Azure Cost Insights: Billing API + Advisor → Databricks → Power BI

**One‑liner:** Ingested **Azure Billing/Cost Management** and **Azure Advisor Recommendations** into **Databricks**, modeled cost & optimization signals, and published **Power BI** dashboards and alerts to reduce spend via **rightsizing, idle cleanup, and commitment planning**.
