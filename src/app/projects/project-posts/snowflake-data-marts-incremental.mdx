...
# Snowflake Data Marts with Incremental Ingestion (PostgreSQL, MongoDB, Databricks) via Apache Airflow

**One‑liner:** Designed and built **Snowflake data marts** with **incremental ingestion** from **PostgreSQL**, **MongoDB**, and **Databricks** (curated Delta exports), orchestrated end‑to‑end by **Apache Airflow**—using **external stages, COPY INTO, Streams/Tasks, and MERGE** for reliable CDC.
