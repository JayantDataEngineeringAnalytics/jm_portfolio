---
title: "Multi-Source CDC Warehouse: Snowflake Data Marts Pipeline"
index: 8
...
Designed and built **Snowflake data marts** with **incremental ingestion** from **PostgreSQL**, **MongoDB**, and **Databricks** (curated Delta exports), orchestrated end‑to‑end by **Apache Airflow**—using **external stages, COPY INTO, Streams/Tasks, and MERGE** for reliable CDC.
