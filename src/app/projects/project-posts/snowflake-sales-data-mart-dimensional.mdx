---
title: "Enterprise Sales Analytics: Snowflake Dimensional Data Mart"
index: 12
...
Designed a **Sales** dimensional model in **Snowflake** using **dbt** for all modeling—clean **facts/dimensions**, SCD handling via **dbt snapshots**, conformed dimensions, and BI‑ready views—fed by incremental pipelines.
