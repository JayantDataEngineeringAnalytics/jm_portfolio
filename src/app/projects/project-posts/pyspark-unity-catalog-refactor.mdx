...
# PySpark Refactor → Unity Catalog‑native Batch & Streaming

**One‑liner:** Refactored legacy PySpark pipelines to leverage **Unity Catalog** features end‑to‑end—**Auto Loader (cloudFiles)**, **Delta schema evolution/enforcement**, **managed tables**, **lineage**, and **policy‑based security**—across both **batch** and **streaming** jobs.
