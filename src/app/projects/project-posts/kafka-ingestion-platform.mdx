---
title: "Kafka Ingestion Platform — MySQL CDC, REST APIs, Azure Blob → Kafka"
...
# Kafka Ingestion Platform — MySQL CDC, REST APIs, Azure Blob → Kafka

**One‑liner:** Built a **Kafka-based ingestion layer** using **Kafka Connect** to stream from **MySQL (CDC)**, **REST APIs** (polling), and **Azure Blob Storage** into well‑governed Kafka topics with schema enforcement, DLQs, and observability—ready for downstream stream processing and batch sinks.
