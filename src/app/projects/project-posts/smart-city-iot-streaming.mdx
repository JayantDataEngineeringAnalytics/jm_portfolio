---
title: "Smart City IoT Streaming: Sensors → Event Hub → Blob → Databricks → Power BI"
...
# Smart City IoT Streaming: Sensors → Event Hub → Blob → Databricks → Power BI

**One‑liner:** Architected a real‑time analytics pipeline to ingest **sensor/IoT** telemetry into **Azure Event Hubs**, land **CSV** batches in **Blob** (Capture), process at scale in **Databricks** with **Auto Loader**, and deliver **Power BI** dashboards for operational insights and city planning.
