...
# Auto Liquid Clustering Optimization for Delta Tables

**One‑liner:** Implemented **Delta Lake Liquid Clustering** with **Auto Optimize** to reduce small files, improve data skipping, and cut end‑to‑end job latency across batch and streaming workloads running under **Unity Catalog**.
