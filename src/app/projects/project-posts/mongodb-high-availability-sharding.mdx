---
title: "Mission-Critical MongoDB: Enterprise HA & Sharding Architecture"
index: 13
...
Designed and implemented **replica sets** for HA and **cluster sharding** for horizontal scale—covering key selection, balancer strategy, resilience controls, and operational automation.
